...
export default async function RecipesPage({
  ...
  const recipes = await getRecipes(resolvedSearchParams);

  // Build search summary
  const searchSummary = [];
  if (resolvedSearchParams.query)
    searchSummary.push(`"${resolvedSearchParams.query}"`);
  if (resolvedSearchParams.cuisine)
    searchSummary.push(`${resolvedSearchParams.cuisine} cuisine`);
  if (resolvedSearchParams.maxReadyTime)
    searchSummary.push(`≤${resolvedSearchParams.maxReadyTime} minutes`);
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-8'>
          <div className='flex items-center justify-between mb-4'>
            <BackButton fallbackHref='/'>Back to Search</BackButton>
          </div>
              ...
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 text-left'>
                ...
                <ol className='text-blue-800 text-sm space-y-1'>
                  <li>
                    ...
                    <a
                      href='https://spoonacular.com/food-api/docs#Authentication'
                      target='_blank'
